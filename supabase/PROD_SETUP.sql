-- ============================================================================
-- Overture — COMPLETE PRODUCTION SETUP (migrations 001–012 + storage)
-- Regenerated 2026-07-05. Paste into a FRESH Supabase project's SQL
-- Editor and Run. Idempotent. NO seed/demo data.
-- Prereq: create Storage buckets in the UI first: photos (public),
--         resumes (private), org-media (public) — bucket INSERTs below
--         then no-op. (show-files bucket is created by migration 010.)
-- ============================================================================
