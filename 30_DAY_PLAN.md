...
- **Schema:** rehearsals, sm_updates, rehearsal_conflicts, (volunteer slots) tables + RLS.
  ...
  - [ ] *Part 2 pending:* volunteer UI in the hub + public `/volunteer/[showId]` guest page (tables + `claim_volunteer_slot`/tokened cancel RPCs already staged in 010). Promotion hub (social templates, QR) + membership CTA still open.
