...
| Reminder cron (`send-reminders`: audition T-24h/T-2h + 48h offer nudges, idempotent via `reminder_log`) | **OPEN** | Built; deploy + 15-min cron pending. See `supabase/SETUP_REMINDERS.md`, migration 008. |
